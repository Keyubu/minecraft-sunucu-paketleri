...
:: 
@echo off
title Keyubu 1.18.2 Skyblock
:start
echo Keyubu 1.18.2 Skyblock paketi etkinlestiriliyor...
...
:: Buradan asagisini, sunucunuzun kapandiginde tekrar baslatılmasını istemiyorsanız silebilirsiniz.
